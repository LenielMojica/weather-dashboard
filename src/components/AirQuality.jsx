  ...
  return (
    <div className="col-span-6 bg-gray-800 rounded-2xl p-5">
      ...
      <div className="flex gap-6 items-center">
        ...
        {/* Círculo AQI */}
        <div className={`w-36 h-36 rounded-full border-8 ${colorAqi[categoria]} flex flex-col items-center justify-center flex-shrink-0`}>
        ...
        <div className="grid grid-cols-2 gap-x-10 gap-y-4 flex-1">
          {contaminantes.map((c, i) => (
            <div key={i} className="flex items-center gap-2">
              <div className={`w-2 h-2 rounded-full flex-shrink-0 ${colorPunto[c.categoria]}`} />
              <div>
